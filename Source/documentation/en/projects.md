...
### 2.1 Pages:
 ###### In this section, you create the project's pages and set its properties.
   ...
   | *New Operation* | Create your own behavior for the page. <br><br>    Click the __CREATE NEW OPERATION__ button to set the behavior of the page. For example, you can trigger __delete, insert or update__ operation(s) for one or more classes. |
